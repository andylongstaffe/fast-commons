...
public class DefaultFastConfiguration implements FastConfiguration {
	...
	private final Logger log = LoggerFactory
			.getLogger(DefaultFastConfiguration.class);

	public DefaultFastConfiguration(String configFilename)
			throws ConfigurationException {
		this(configFilename, "dev");
	}

	public DefaultFastConfiguration(String configFilename, String defaultEnvType)
			throws ConfigurationException {
	...
	private void loadConfig(String configFilename, String defaultEnvType)
			throws ConfigurationException {
	...
	private String getConfigFileLocation(String envtype, String configFilename) {
		String configFile = "configuration" + File.separator + envtype
	...
	private String getEnvType(String defaultEnvType) {
		if ((envtype = System.getProperty("envtype")) != null) {
			log.info("Environment set to " + envtype
					+ " via system property envtype");
		} else if ((envtype = System.getenv("envtype")) != null) {
			log.info("Environment set to " + envtype
					+ " via environment variable envtype");
		} else {
